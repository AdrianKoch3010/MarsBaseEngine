...
bool RenderInformationComponent::IsAbove(const RenderInformationComponent& renderInformationComponent) const
{
...
bool RenderInformationComponent::IsAbove(const RenderInformationComponent& a, const RenderInformationComponent& b)
{
	return b.IsAbove(a);
}
